...
/* notes:
- use parser on a string
- look at the command and choose the table function
- p tree from parser has all of the things, command tells you what func to call on table
*/
